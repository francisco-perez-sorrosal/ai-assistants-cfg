...
![Agent Pipeline Flowchart — promethean through verifier with context-engineer, sentinel, and architect-validator](diagrams/agent-pipeline-flowchart/rendered/agent-pipeline-flowchart.svg)
