...
| `verifier` | Verifies completed implementation against acceptance criteria, coding conventions, and test coverage; produces `VERIFICATION_REPORT.md` with pass/fail/warn findings; runs interface design review (conditional on `INTERFACE_DESIGN.md` presence) | `code-review`, `web-ui-design`, `tui-design`, `agentic-interface-design`, `api-design-craft` |
