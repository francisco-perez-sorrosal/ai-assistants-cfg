...
|-----|----------|---------------------|
| [dec-017](decisions/017-deployment-skill-local-first-compose-center.md) | Docker Compose as deployment gravity center | Compose is the primary deployment descriptor |
| [dec-018](decisions/018-deployment-skill-opinionated-defaults.md) | Opinionated tool defaults (Caddy, Railway/Render) | Default tool choices for proxy and PaaS |
