...
| **Last verified** | 2026-05-12 — dashboard-redesign (Built): Pipeline Dashboard row reflects completed implementation — interactive viz layer (ADR graph, step DAG, recharts charts), Sentrux purge, diagram serving, design tokens, Diátaxis shells, `docs/architecture.md` updated. Prior: multi-language-support (Built) — Polyglot skill plane row to Built. See [DESIGN_CHANGELOG.md](DESIGN_CHANGELOG.md) for verification history. |
